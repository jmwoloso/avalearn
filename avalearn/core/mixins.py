...
class TreatmentDesignMixin(object):
    """
    Mixin class defining core functionality for TreatmentDesign-related
    classes.
    """
...
class TreatmentDesignCategorical(TreatmentDesignMixin):
    """
...
class TreatmentDesignNumeric(TreatmentDesignMixin):
    """
